...
- FIRST scene text is the HOOK — the first 1-2 seconds decide if the viewer keeps watching or swipes away. It MUST follow ALL of these:
  1) MAX 8-10 words, no filler, no throat-clearing (no "Bugün", "Az önce yaşanan bir olayda" style windups) — the hook itself must be the very first words spoken.
  2) CURIOSITY-GAP — never state the answer/outcome in the first sentence. Create suspense or a partial reveal so the viewer NEEDS the next scene to find out. Examples: "Kimse beklemiyordu:", "Meğer...", "Az önce ortaya çıktı:", "Herkes bunu merak ediyordu — cevap şoke etti.", "Peki gerçekte ne oldu?". Do NOT repeat the same opener across videos.
  3) PERSONAL-IMPACT framing whenever the topic allows it — make the viewer feel directly affected, not just an observer. Prefer angles like "seni ilgilendiriyor", "milyonlarca kişiyi etkileyecek", "cebini/hayatını değiştirecek" over neutral third-person reporting. Topics with a direct personal-impact angle (money, rights, health, safety, prices, jobs) consistently outperform purely observational news (celebrity, distant politics) — lean into the personal-impact angle whenever the topic has one.
  4) NEVER open with a plain, fully-informative news statement — the viewer must have zero reason to swipe away before scene 2.
...
_IG_WEEKLY_SCHEDULE = {
    ...
    "tue": ["06:10", "07:38", "09:05", "10:30", "11:55", "13:22", "14:50", "16:15", "17:42", "19:08", "20:35", "22:10"],
